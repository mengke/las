...
Recommendation.prototype.write = function(output) {
  ...
  if (this.itemType !== null && this.itemType !== undefined) {
    output.writeFieldBegin('itemType', Thrift.Type.BYTE, 2);
    output.writeByte(this.itemType);
    output.writeFieldEnd();
  }
  if (this.prefValue !== null && this.prefValue !== undefined) {
    output.writeFieldBegin('prefValue', Thrift.Type.I32, 3);
    output.writeI32(this.prefValue);
    output.writeFieldEnd();
  }

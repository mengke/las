...
public class TestHouseVisiting {
    ...
    public void setUp() throws Exception {
        ...
        mapReduceDriver.setKeyGroupingComparator(new FirstPartitioner.GroupComparator());
        mapReduceDriver.setKeyOrderComparator(new FirstPartitioner.KeyComparator());
    }
